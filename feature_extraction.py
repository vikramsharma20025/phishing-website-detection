...
def extract_features(url):
    # detect key	having_IP	URL_Length	Shortining_Service	having_At_Symbol	double_slash_redirecting	Prefix_Suffix	having_Sub_Domain	SSLfinal_State	Domain_registeration_length	Favicon	port	HTTPS_token	Request_URL	URL_of_Anchor	Links_in_tags	SFH	Submitting_to_email	Abnormal_URL	Redirect	on_mouseover	RightClick	popUpWidnow	Iframe	age_of_domain	DNSRecord	web_traffic	Page_Rank	Google_Index	Links_pointing_to_page	Statistical_report
    ...
    extracted_features = FeatureExtraction(url).getFeaturesList()

    # # 1. Having IP
    # features.append(UsingIp(url))
    # # 2. Long URL
    ...
    # # 5. Redirecting //
    # features.append(redirecting(url))
    # # 6. Prefix Suffix
    # features.append(prefixSuffix(url))
    # # 7. SubDomains
    # features.append(SubDomains(url))
    # # 8. HTTPS
    # features.append(Hppts(url))
    # # 9. Domain Registration Length
    # features.append(DomainRegLen(url))
    # # 10. Favicon
    # features.append(Favicon(url))
    # # 11. Non-Standard Port
    # features.append(NonStdPort(url))
    # # 12. HTTPS Domain URL
    # # features.append(HTTPSDomainURL(url))
    # # 13. Request URL
    # features.append(RequestURL(url))
    # # 14. Anchor URL
    # features.append(AnchorURL(url))
    # # 15. Links In Script Tags
    # features.append(LinksInScriptTags(url))
    # # 16. Server Form Handler
    # features.append(ServerFormHandler(url))
    # # 17. Info Email
    # features.append(InfoEmail(url))
    # # 18. Abnormal URL
    # features.append(AbnormalURL(url))
    # # 19. Website Forwarding
    # features.append(WebsiteForwarding(url))
    # # # 20. Status Bar Customization
    # # features.append(StatusBarCust(url))
    # # 21. Disable Right Click
    # features.append(DisableRightClick(url))
    # # 22. Using Popup Window
    # features.append(UsingPopupWindow(url))
    # # 23. Iframe Redirection
    # features.append(IframeRedirection(url))
    # # 24. Age of Domain
    # features.append(AgeofDomain(url))
    # # 25. DNS Recording
    # features.append(DNSRecording(url))
    # # 26. Website Traffic
    ...
    # features.append(LinksPointingToPage(url))
    # # 30. Stats Report
    # features.append(StatsReport(url))
